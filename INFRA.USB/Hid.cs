...
namespace UsbHid.USB.Classes.DllWrappers
{
    public static class Hid
    {
        ...
        [DllImport("hid.dll", SetLastError = true)]
        public static extern bool HidD_GetAttributes(SafeFileHandle hidDeviceObject, ref Win32Usb.HIDD_ATTRIBUTES attributes);
        ...
        [DllImport("hid.dll", SetLastError = true)]
        public static extern Int32 HidP_GetCaps(IntPtr preparsedData, ref Win32Usb.HidCaps capabilities);
